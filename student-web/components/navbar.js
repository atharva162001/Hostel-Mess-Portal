      ...
      <div className="dark:bg-gray-900 bg-[#64748b] z-10 w-full xl:grid xl:place-items-center fixed">
         <nav className="dark:bg-gray-900 bg- text-slate-200 xl:flex xl:container ">
            ...
            <ul className={(showMobileMenu ? "" : "hidden") + ` xl:ml-2 xl:flex pb-2 xl:gap-0  `}>
               ...
               <li className="py-2 grid place-items-center xl:mx-2"><a href={`/${userName}/complaintbox`} className="p-2  text-black dark:text-white text-center rounded font-bold hover:bg-blue-700 hover:text-white">ComplaintBox</a></li>
               ...
               <li className="py-2 grid place-items-center xl:mx-2"><a href={`/${userName}/qrcode`} className="p-2  text-black dark:text-white text-center rounded font-bold hover:bg-blue-700 hover:text-white">QrCode</a></li>
               <li className="py-2 grid place-items-center xl:mx-2"><a href={`/${userName}/payment`} className="p-2  text-black dark:text-white text-center rounded font-bold hover:bg-blue-700 hover:text-white">Payment</a></li>
               <li className="py-2 grid place-items-center xl:mx-2"><a href={`/${userName}/profile`} className="p-2  text-black dark:text-white text-center rounded font-bold hover:bg-blue-700 hover:text-white">Profile</a></li>
            </ul>
            {/* <Switch></Switch> */}
         </nav>
      </div>
